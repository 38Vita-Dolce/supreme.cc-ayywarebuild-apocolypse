...
void ClanTag()
{
	...
	case 2:
	{
		...
		switch (value) {
		case 0:SetClanTag("Supreme.cc", "Supreme.cc"); break;
		case 1:SetClanTag("Supreme.cc", "Supreme.cc"); break;
		case 2:SetClanTag("Supreme.cc", "Supreme.cc"); break;
		case 3:SetClanTag("Supreme.cc", "Supreme.cc"); break;
		case 4:SetClanTag("Supreme.cc", "Supreme.cc"); break;
		case 5:SetClanTag("Supreme.cc", "Supreme.cc"); break;
	    case 6:SetClanTag("neXus says hi", "neXus says hi"); break;
		}
		counter++;
	}
	break;
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	{ 
		...
		if (Menu::Window.MiscTab.OtherWatermark.GetState())
		{
			...
			RECT TextSize = Render::GetTextSize(Render::Fonts::ESP, "Supreme.cc");
